  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          ref={rowRef}
          className="flex items-center overflow-x-auto scrollbar-hide space-x-4 px-2 scroll-smooth"
...
function RowCard({ item, index }) {
  ...
  // Get poster URL with quality settings
  ...
  return (
    <motion.div
      ...
      whileHover={{
        scale: settings.reduceMotion ? 1 : 1.05,
        ...
        <div className="relative w-40 h-60 rounded-lg overflow-hidden bg-bg-tertiary">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-300">
            <div className="absolute bottom-0 left-0 right-0 p-3">
              <p className="text-floral-white text-sm font-medium line-clamp-2">
                {item.name || item.title}
              </p>
              <p className="text-floral-white/70 text-xs mt-1">
