...
const cspHeader = [
  ...
  // Direct playback is same-origin through /api/stream/proxy. Keep external
  // network access limited to APIs the browser actually calls.
  `connect-src 'self' https://api.themoviedb.org https://api.github.com https://webservice.fanart.tv https://firestore.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://firebase.googleapis.com https://firebaseinstallations.googleapis.com https://*.googleapis.com https://*.firebaseio.com https://www.google-analytics.com https://stats.g.doubleclick.net${isProd ? '' : ' http://localhost:*'}`,
  "media-src 'self' blob:",
