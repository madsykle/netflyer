...
const cspHeader = [
  ...
  `connect-src 'self' https://api.themoviedb.org https://webservice.fanart.tv https://firestore.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://firebase.googleapis.com https://firebaseinstallations.googleapis.com https://*.googleapis.com https://*.firebaseio.com https://www.google-analytics.com https://stats.g.doubleclick.net https://*.vidzee.wtf https://*.4khdhub.com https://*.mp4hydra.net https://vixsrc.io https://vixsrc.to https://*.vixsrc.to https://*.sc-u8-01.vixsrc.to https://xprime.com.ng https://moviesmod.com https://showbox.apptm.sclevercomputech.com https://febbox.com https://pstream.net${isProd ? '' : ' http://localhost:*'}`,
