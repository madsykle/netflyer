...
const cspHeader = [
  ...
  "img-src 'self' data: https://image.tmdb.org https://images.unsplash.com https://lh3.googleusercontent.com https://www.google-analytics.com https://www.googletagmanager.com",
  "font-src 'self' https://fonts.gstatic.com",
  `connect-src 'self' https://api.themoviedb.org https://firestore.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://firebase.googleapis.com https://firebaseinstallations.googleapis.com https://*.googleapis.com https://*.firebaseio.com https://www.google-analytics.com https://stats.g.doubleclick.net https://*.vidzee.wtf https://*.4khdhub.com https://*.mp4hydra.net https://vixsrc.io https://vixsrc.to https://*.vixsrc.to https://*.sc-u8-01.vixsrc.to https://xprime.com.ng https://moviesmod.com https://showbox.apptm.sclevercomputech.com https://febbox.com https://pstream.net${isProd ? '' : ' http://localhost:*'}`,
  "media-src 'self' blob: https://*.vidzee.wtf https://*.4khdhub.com https://*.mp4hydra.net https://vixsrc.io https://vixsrc.to https://*.vixsrc.to https://*.sc-u8-01.vixsrc.to https://xprime.com.ng https://moviesmod.com https://showbox.apptm.sclevercomputech.com https://febbox.com https://pstream.net https://vidplay.filmogle.top https://streamwish.com https://vidguard.com https://streamtape.com https://doodstream.com https://filemoon.sx https://highload.to https://vtube.to https://voe.sx",
